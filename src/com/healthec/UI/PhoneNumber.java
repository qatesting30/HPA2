...
import static com.healthec.generic.utils.TestBaseClass.testdataSheet;
...
public class PhoneNumber {
    ...
    public static void phoneNumberIos(RemoteWebDriver driver)
    {
        ...
        Assert.assertTrue(driver.findElement(By.xpath("//XCUIElementTypeButton[@name='Cancel']")).isDisplayed());
