...
public ProfilePageObjects(RemoteWebDriver driver)
{
    ...
    @FindBy(xpath="//strong[contains(text(),'Profile1')]")
    public static WebElement profile_page1;
    ...
    @FindBy(xpath="//strong[contains(text(),'Contacts')]")
    public static WebElement contacts_page;
    @FindBy(xpath="strong[contains(text(),'Contacts')")
    public static WebElement contacts_page1;
    @FindBy(id="idContactsPersonal")
    public static WebElement personal_tab;
    @FindBy(xpath="//img[@src='assets/images/profile/contacts/Personal_Blue.png']")
    public static WebElement personal_tab_selected;
    @FindBy(xpath="img[@src='assets/images/profile/contacts/Personal_Blue.png']")
    public static WebElement personal_tab_selected1;
    ...
    @FindBy(id="messagePopup1")
    public static WebElement personal_added_successfully_popUp;
    @FindBy(id="idOk1")
   ...
   //Emergency
    ...
    @FindBy(xpath="//img[@src='assets/images/profile/contacts/Emergency_Blue.png']")
    public static WebElement emergency_tab_selected;
    @FindBy(xpath="img[@src='assets/images/profile/contacts/Emergency_Blue.png']")
    public static WebElement emergency_tab_selected1;
    ...
    @FindBy(id="idOk1")
    public static WebElement emergency_updated_sucessfully_popup_ok_btn;
    //physicians
    @FindBy(xpath="//div[contains(text(),'Physicians')]")
    public static WebElement physicians_tab;
    @FindBy(xpath="//strong[contains(text(),'Physicians')]")
    public static WebElement physicians_page;
   ...
   /* @FindBys({@FindBy (xpath="//span[contains(text(),'Physician Type')]"),@FindBy (xpath="//span[contains(text(),'Physician Name')]"),
    ...
    @FindBy(xpath="//div[@class='Record_One']/div[@class='Record_Right_One']//span[@class='Record_Line1']")
    public static List<WebElement> physician_recordspage_physician_name;
    @FindBy(className="Record_Main")
    public static List<WebElement> physician_recordspage;
    //pharmacy
    @FindBy(xpath="//div[contains(text(),'Pharmacy')]")
    public static WebElement pharmacy_tab;
    @FindBy(xpath="//strong[contains(text(),'Pharmacy')]")
    public static WebElement pharmacy_page;
    ...
    public static WebElement add_pharmacy_btn;
    @FindBy(id="idMsg")
