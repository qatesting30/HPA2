...
public class DashboardPageObjects {
  ...
  public DashboardPageObjects (RemoteWebDriver driver) {
   ...
   //Moods
    ...
    //dashboard-box
    @FindBy(xpath = "//li[@class='calorie-box']")
    public WebElement calorie_box;
    @FindBy(xpath = "//li[@class='bmibox']")
    public WebElement bmi_box;
    @FindBy(className = "//li[@class='bp-box']")
   ...
   /* @FindBy(xpath = "//ul[@id='check']/li[contains(@class,'day-pa')]")
    ...
    @FindBy(xpath="//div[@class='calendar-main-box']")
    public WebElement calender_section;
    @FindBy(xpath="div[@class='calendar-main-box']")
    public WebElement calender_section1;
